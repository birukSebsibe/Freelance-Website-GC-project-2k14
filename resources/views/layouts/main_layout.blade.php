...
<head>
    ...
    {{-- <link href={{"front_end/assets/css/style.css"}} rel="stylesheet"> --}}
    <link href="{{ asset('front_end/assets/css/style.css') }}" rel="stylesheet">
    <link href="{{ asset('front_end/assets/css/tabularlisting.css') }}" rel="stylesheet">
...
<script src="{{asset('pagination/app.js')}}"></script>
