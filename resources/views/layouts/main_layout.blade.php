...
<head>
    ...
    <!-- Favicon -->
    <link href="{{asset('front_end/img/mesob3.png')}}" rel="icon">
    ...
    <div class="container-xxl bg-white p-0">
     ...
     <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a class="navbar-brand d-flex align-items-center text-center py-0 px-4 px-lg-5">
            <h1 class="m-0 text-primary">Mesob</h1>
        </a>
        ...
        <div class="copyright">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="border-bottom" href="#">Mesob.com</a>, All Right Reserved.
                </div>
...
<!-- Back to Top -->
<a href="#" class="btn btn-lg btn-primary btn-lg-square back-to-top" onclick="" scrollToTop()"><i
